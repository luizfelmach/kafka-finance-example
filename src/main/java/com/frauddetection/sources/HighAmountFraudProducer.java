...
public class HighAmountFraudProducer {
    ...
    public static void main(String[] args) {
        ...
        double amount = 80000.0 + RANDOM.nextDouble() * 70000.0; // R$ 80.000 – R$ 150.000 (acima do LIMIT=50.000)
        ...
        producer.close();
        System.out.println("HighAmountFraudProducer finished.");
    }
